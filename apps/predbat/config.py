...
INVERTER_DEF = {
    ...
    "AlphaESSController": {
        "name": "AlphaESS via guarded Home Assistant services",
        "has_rest_api": False,
        "has_mqtt_api": False,
        # The Home Assistant integration owns all physical writes. Predbat only
        # issues immediate semantic service requests (charge, export, Mode 19,
        # normal) and keeps its internal rate/time entities private.
        "output_charge_control": "none",
        "charge_control_immediate": True,
        "has_charge_enable_time": False,
        "has_discharge_enable_time": False,
        ...
        "has_time_window": False,
        "support_charge_freeze": False,
        # AlphaESS Mode 19 prevents PV charging and exports surplus PV while
        # still allowing the battery to serve a house-load shortfall.
        "support_discharge_freeze": True,
        "has_idle_time": False,
        "can_span_midnight": False,
        "charge_discharge_with_rate": False,
...
APPS_SCHEMA = {
    ...
    "plan_alphaess_mode_column": {"type": "boolean"},
    "plan_towel_schedule_column": {"type": "boolean"},
    "plan_alphaess_high_soc_enter": {"type": "float", "zero": False},
    "plan_alphaess_high_soc_exit": {"type": "float", "zero": False},
